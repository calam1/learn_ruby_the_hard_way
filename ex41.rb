...
def central_corridor
  ...
  puts "put it in the birdge, and blow the ship up after getting into an "
  puts "escape pod."
  puts "\n"
  ...
  if action == "shoot!"
    ...
    puts "In the middle of y our artful dodge your foot slips and you"
...
def the_bridge
  puts "You burst onto the Bridge with the netron destuct bomb"
  puts "under you arm and surprise 6 Gothons who are trying to"
  ...
  if action == "throw the bomb"
    ...
    puts "place the bomb on the floee, pointing your blaster at it."
...
def escape_pod
  ...
  puts "the escape pod before the whole ship explides.  It seems like"
  puts "hardly any Gothons are on the ship, so your run is clear of"
  puts "interference.  You get to the chamber with the escape pods, and"
  puts "now need to picl one to take.  Some of them could be damaged"
